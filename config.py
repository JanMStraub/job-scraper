...
LINKEDIN_JOB_TYPE = (
    "F"  # F=Full-time, C=Contract, P=Part-time, T=Temporary, I=Internship
)
...
SCRAPING_SOURCES = [
    ...
    "jooble",
    "workwise",
]  # Also available: "linkedin", "careers_future", "meinestadt"
...
USE_PROXIES = False
PROXY_LIST = [
    # Add proxies in format 'http://username:password@ip:port' or 'http://ip:port'
]
